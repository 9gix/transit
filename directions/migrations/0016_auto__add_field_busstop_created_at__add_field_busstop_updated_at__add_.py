...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusStop.created_at'
        db.add_column(u'directions_busstop', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 9, 0, 0)),
                      keep_default=False)

        # Adding field 'BusStop.updated_at'
        db.add_column(u'directions_busstop', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 9, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Route.created_at'
        db.add_column(u'directions_route', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 9, 0, 0)),
                      keep_default=False)

        # Adding field 'Route.updated_at'
        db.add_column(u'directions_route', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 9, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Bus.created_at'
        db.add_column(u'directions_bus', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 9, 0, 0)),
                      keep_default=False)

        # Adding field 'Bus.updated_at'
        db.add_column(u'directions_bus', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusStop.created_at'
        db.delete_column(u'directions_busstop', 'created_at')

        # Deleting field 'BusStop.updated_at'
        db.delete_column(u'directions_busstop', 'updated_at')

        # Deleting field 'Route.created_at'
        db.delete_column(u'directions_route', 'created_at')

        # Deleting field 'Route.updated_at'
        db.delete_column(u'directions_route', 'updated_at')

        # Deleting field 'Bus.created_at'
        db.delete_column(u'directions_bus', 'created_at')

        # Deleting field 'Bus.updated_at'
        db.delete_column(u'directions_bus', 'updated_at')
